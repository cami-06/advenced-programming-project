...
from scanners.traversal.traversal_scanner import TraversalScanner
...
# XSS scan
# ======================
xss_scanner = XSSScanner(crawler, http_client, reporter)
xss_scanner.scan()

# ======================
# Traversal scan
# ======================
traversal_scanner = TraversalScanner(crawler, http_client, reporter)
traversal_scanner.scan()
